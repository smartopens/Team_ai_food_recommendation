...
2020년도 대학교에서 수강한 산합혁력 프로젝트수업에서 진행된 프로젝트입니다. 멘토분은 Microsoft 본사에서 데이터사이언티스트로 근무하고 계셨던 심재은 멘토분입니다.
...
하지만 인공지능 분야의 프로젝트를 진행한다는 것이 새로웠고 팀원들과 열심히 고생하고 지도교수님, 그리고 멘토님의 조언을 받으면서 나름 성공적으로 프로젝트를 마무리 했습니다.
